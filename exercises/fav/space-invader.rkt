...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ii_arbitrary_large_data_224__225) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
